...
CREATE TABLE `borrowing_books` (
                                  ...
                                  CONSTRAINT `borrowing_books_ibfk_1` FOREIGN KEY (`book_id`) REFERENCES `book` (`book_id`),
                                  CONSTRAINT `borrowing_books_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`)
) ENGINE=InnoDB AUTO_INCREMENT=62 DEFAULT CHARSET=utf8;

INSERT INTO `borrowing_books` VALUES ('9', '5', '1', '2020-08-04');
INSERT INTO `borrowing_books` VALUES ('28', '5', '19', '2020-08-01');
INSERT INTO `borrowing_books` VALUES ('31', '2', '20', '2020-08-02');
INSERT INTO `borrowing_books` VALUES ('55', '1', '21', '2020-08-19');
INSERT INTO `borrowing_books` VALUES ('57', '1', '17', '2020-08-19');
INSERT INTO `borrowing_books` VALUES ('61', '1', '16', '2020-08-21');
